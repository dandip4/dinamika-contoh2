...
function updateCarousel() {
    ...
    clientsTrack.style.transform = `translateX(-${currentPosition * slideWidth}px)`;
...
clientsCarousel.addEventListener('mouseenter', stopAutoScroll);
clientsCarousel.addEventListener('mouseleave', startAutoScroll);
